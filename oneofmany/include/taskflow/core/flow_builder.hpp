...
class FlowBuilder {
  ...
  */
  ...
  For example, the src below find the element that satisfies the given
  ...
  */
  ...
  For example, the src below find the smallest element from an input
  ...
  */
  ...
  For example, the src below find the largest element from an input
  range of 10 elements.
